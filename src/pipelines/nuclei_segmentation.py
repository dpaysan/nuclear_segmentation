...
from src.segmentation.basic_segmentation import get_watershed_labels, get_edge_based_labels
...
class ProjectedWatershed3dSegmentationPipeline(SegmentationPipeline):
    ...
    def segment_by_canny_edge_detection(self, sigma: float = 3.0, low_threshold: float = None,
                                        high_threshold: float = None):
        self.labeled_projection = get_edge_based_labels(img=self.processed_projection, sigma=sigma,
