...
output_dir = '../../data/tcell_project/human_cd4/split_raw_data/filtered_splits/tzyxc_pkl'
os.makedirs(output_dir, exist_ok=True)
data_infos = pd.read_csv('../../data/tcell_project/human_cd4/data_list.csv')
nan_rows = data_infos.iloc[:,1:].isnull().all(axis=1)
filtered_slice_names = data_infos.loc[nan_rows].iloc[:,0]

all_files = get_file_list('../../data/tcell_project/human_cd4/split_raw_data/unfiltered_splits/tzyxc_pkl/pkl_files')
filtered_files = []
